...
@section('title', 'Додавання роботи')
@section('content')
<div class="page__title">
    <a href="{{ route('moderator.index') }}">Головна</a>
    <img src="{{ asset('img/next.png') }}" alt="next">
    <a href="{{ route('moderator.addWork') }}">Додавання роботи</a>
</div>
<div class="user-add-work block">
    ...
    <form action="{{ route('moderator.newWork') }}" method="POST" enctype="multipart/form-data">
        @csrf
